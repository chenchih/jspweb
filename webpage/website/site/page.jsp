...
<%
        ...
        if((cPage*iTotalSearchRecords)-(iTotalSearchRecords)>0)
        {
		 ...
		 a href="page.jsp?iPageNo=<%=prePageNo%>&cPageNo=<%=prePageNo%>"> << Previous</a>
         <%
        }
        ...
        for(i=((cPage*iTotalSearchRecords)-(iTotalSearchRecords-1));i<=(cPage*iTotalSearchRecords);i++)
        {
          ...
          {
          %>
           <a style="cursor:default;color: red"><b><%=i%></b></a>
        ...
        {
         %>
         <a href="page.jsp?iPageNo=<%=i%>&cPageNo=<%=i%>"> >> Next</a> 
         <%
        }
