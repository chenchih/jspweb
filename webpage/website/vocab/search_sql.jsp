...
//  String strUrl1 = "jdbc:mysql://localhost:3306/account?user=root&characterEncoding=big5";
 String strUrl1 = "jdbc:mysql://localhost:3306/webapp?user=root&characterEncoding=big5";
  ...
  sql = "select term_eng from vocab where term_eng like '" 
  			+ term  + "%' order by term_eng;";
  ...
  sb.append("{\"term_eng\":\"" + rs.getString("term_eng")+"\"}");
